...
[**delete_llm_model_price_by_query**](LLMPriceConfigurationApi.md#delete_llm_model_price_by_query) | **DELETE** /api/settings/llm-pricing | Delete LLM model price
...
[**upsert_llm_model_price_from_body**](LLMPriceConfigurationApi.md#upsert_llm_model_price_from_body) | **PUT** /api/settings/llm-pricing | Upsert LLM model price
...
# **delete_llm_model_price_by_query**
> delete_llm_model_price_by_query(provider=provider, model_name=model_name, platform=platform)
...
with instana_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = instana_client.LLMPriceConfigurationApi(api_client)
    provider = 'openai' # str |  (optional)
    model_name = 'gpt-4' # str |  (optional)
    platform = 'aws' # str |  (optional)

    try:
        # Delete LLM model price
        api_instance.delete_llm_model_price_by_query(provider=provider, model_name=model_name, platform=platform)
    except Exception as e:
        print("Exception when calling LLMPriceConfigurationApi->delete_llm_model_price_by_query: %s\n" % e)
```
...
# **upsert_llm_model_price_from_body**
> upsert_llm_model_price_from_body(llm_model_price=llm_model_price)
...
with instana_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = instana_client.LLMPriceConfigurationApi(api_client)
    llm_model_price = {"provider":"openai","modelName":"gpt-4","inputCost":0.5,"outputCost":1.5} # LlmModelPrice |  (optional)

    try:
        # Upsert LLM model price
        api_instance.upsert_llm_model_price_from_body(llm_model_price=llm_model_price)
    except Exception as e:
        print("Exception when calling LLMPriceConfigurationApi->upsert_llm_model_price_from_body: %s\n" % e)
```
