...
Synthetic test configuration that is unique to a synthetic type. Valid types are BrowserScript, DNS, ICMP, HTTPAction, HTTPScript, SSLCertificate, WebpageAction, and WebpageScript.
