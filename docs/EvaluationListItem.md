...
**schedule_end_date** | **int** |  | [optional] 
**schedule_end_occurrences** | **int** |  | [optional] 
**schedule_end_type** | **str** |  | [optional] 
**schedule_frequency** | **str** |  | [optional] 
**schedule_next_run_time** | **int** |  | [optional] 
**schedule_run_count** | **int** |  | [optional] 
**schedule_start_time** | **int** |  | [optional] 
**schedule_timezone** | **str** |  | [optional] 
**schedule_week_days** | **List[str]** |  | [optional] 
