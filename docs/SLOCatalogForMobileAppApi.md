...
------------- | ------------- | -------------
[**get_mobile_app_sli_metric_catalog**](SLOCatalogForMobileAppApi.md#get_mobile_app_sli_metric_catalog) | **GET** /api/slo/catalog/metrics/mobile | Mobile app SLI metric catalog
[**get_mobile_app_slo_tag_catalog**](SLOCatalogForMobileAppApi.md#get_mobile_app_slo_tag_catalog) | **GET** /api/slo/catalog/tags/mobile | Get mobile app monitoring tag catalog for Mobile App SLOs
