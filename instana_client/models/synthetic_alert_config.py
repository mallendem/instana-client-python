...
class SyntheticAlertConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["affectedLocationsCount", "alertChannelIds", "customPayloadFields", "description", "evaluationType", "gracePeriod", "includeOnDemand", "name", "rule", "severity", "syntheticTestIds", "tagFilterExpression", "timeThreshold"]
