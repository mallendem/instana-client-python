...
class SyntheticAlertConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "customPayloadFields", "description", "gracePeriod", "name", "rule", "severity", "syntheticTestIds", "tagFilterExpression", "timeThreshold"]
