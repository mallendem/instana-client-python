...
class RecurrentMaintenanceWindow(MaintenanceConfigScheduling):
    """
    RecurrentMaintenanceWindow
    """ # noqa: E501
    rrule: Annotated[str, Field(min_length=1, strict=True)]
    timezone_id: Optional[StrictStr] = Field(default=None, alias="timezoneId")
    __properties: ClassVar[List[str]] = ["duration", "start", "type", "rrule", "timezoneId"]
