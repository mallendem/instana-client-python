...
class ServiceScopedToWithMetadata(BaseModel):
    """
    The release marker would be present in the service but not for other services within the Application perspective.
    """ # noqa: E501
    applications: Annotated[List[ApplicationScopeWithMetadata], Field(min_length=1, max_length=10)] = Field(description="The list of application perspectives where the service is present. ")
