...
class ChangeSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author", "changeType"]

    @field_validator('change_type')
    def change_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CREATE', 'UPDATE', 'DELETE', 'ENABLE', 'DISABLE', 'RESTORE', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('CREATE', 'UPDATE', 'DELETE', 'ENABLE', 'DISABLE', 'RESTORE', 'UNKNOWN')")
        return value
