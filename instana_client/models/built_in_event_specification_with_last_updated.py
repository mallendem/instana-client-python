...
class BuiltInEventSpecificationWithLastUpdated(BaseModel):
    ...
    supported_poll_rate_seconds: Optional[StrictInt] = Field(default=None, alias="supportedPollRateSeconds")
    ...
    __properties: ClassVar[List[str]] = ["description", "enabled", "hidden", "hyperParams", "id", "lastUpdated", "name", "ruleInputs", "severity", "shortPluginId", "supportedPollRateSeconds", "triggering"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supportedPollRateSeconds": obj.get("supportedPollRateSeconds"),
