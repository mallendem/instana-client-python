...
class SyntheticTestDeepUpdate(SyntheticTestUpdate):
    """
    SyntheticTestDeepUpdate
    """ # noqa: E501
    configuration: Optional[SyntheticTypeConfigurationUpdate] = None
    __properties: ClassVar[List[str]] = ["active", "applications", "customProperties", "ids", "lastModifiedAt", "locations", "mobileApps", "modifiedBy", "rbacTags", "shallowUpdate", "syntheticUpdateType", "testFrequency", "websites", "configuration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rbac_tags
        if self.rbac_tags:
            _dict['rbacTags'] = self.rbac_tags.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rbacTags": SyntheticResourceUpdateListStringListString.from_dict(obj["rbacTags"]) if obj.get("rbacTags") is not None else None,
            ...
            "configuration": SyntheticTypeConfigurationUpdate.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
