...
class GetApplicationMetrics(BaseModel):
    """
    GetApplicationMetrics
    """ # noqa: E501
    include_internal: Optional[StrictBool] = Field(default=None, alias="includeInternal")
    include_synthetic: Optional[StrictBool] = Field(default=None, alias="includeSynthetic")
    ...
    __properties: ClassVar[List[str]] = ["includeInternal", "includeSynthetic", "metrics", "tagFilterExpression", "timeFrame"]
