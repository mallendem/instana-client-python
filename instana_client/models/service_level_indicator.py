...
class ServiceLevelIndicator(BaseModel):
    ...
    def blueprint_validate_enum(cls, value):
        ...
        if value not in set(['latency', 'availability', 'traffic', 'saturation', 'custom', 'advanced-custom']):
            raise ValueError("must be one of enum values ('latency', 'availability', 'traffic', 'saturation', 'custom', 'advanced-custom')")
        return value
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'advanced-custom': 'AdvancedCustomBlueprintIndicator','availability': 'AvailabilityBlueprintIndicator','custom': 'CustomBlueprintIndicator','latency': 'LatencyBlueprintIndicator','saturation': 'SaturationBlueprintIndicator','traffic': 'TrafficBlueprintIndicator'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AdvancedCustomBlueprintIndicator, AvailabilityBlueprintIndicator, CustomBlueprintIndicator, LatencyBlueprintIndicator, SaturationBlueprintIndicator, TrafficBlueprintIndicator]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AdvancedCustomBlueprintIndicator, AvailabilityBlueprintIndicator, CustomBlueprintIndicator, LatencyBlueprintIndicator, SaturationBlueprintIndicator, TrafficBlueprintIndicator]]:
        """Create an instance of ServiceLevelIndicator from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'AdvancedCustomBlueprintIndicator':
            return import_module("instana_client.models.advanced_custom_blueprint_indicator").AdvancedCustomBlueprintIndicator.from_dict(obj)
