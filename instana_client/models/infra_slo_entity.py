...
class InfraSloEntity(SloEntity):
    """
    InfraSloEntity
    """ # noqa: E501
    infra_type: StrictStr = Field(description="Infrastructure Type", alias="infraType")
    __properties: ClassVar[List[str]] = ["tagFilterExpression", "type", "infraType"]
