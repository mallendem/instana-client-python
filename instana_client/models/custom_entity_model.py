...
class CustomEntityModel(BaseModel):
    """
    CustomEntityModel
    """ # noqa: E501
    dashboards: Optional[List[CustomDashboard]] = None
    dependencies: Optional[List[CustomDependency]] = None
    identifiers: List[StrictStr]
    ...
    tags: Optional[List[CustomTag]] = None
    __properties: ClassVar[List[str]] = ["dashboards", "dependencies", "identifiers", "label", "metrics", "name", "tagFilterExpression", "tags"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tags:
            ...
            _dict['tags'] = _items
        # set to None if dashboards (nullable) is None
        # and model_fields_set contains the field
        if self.dashboards is None and "dashboards" in self.model_fields_set:
            _dict['dashboards'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dashboards": [CustomDashboard.from_dict(_item) for _item in obj["dashboards"]] if obj.get("dashboards") is not None else None,
            "dependencies": [CustomDependency.from_dict(_item) for _item in obj["dependencies"]] if obj.get("dependencies") is not None else None,
            "identifiers": obj.get("identifiers"),
            "label": obj.get("label"),
            "metrics": [CustomMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "name": obj.get("name"),
            ...
            "tags": [CustomTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
