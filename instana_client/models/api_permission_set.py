...
class ApiPermissionSet(BaseModel):
    ...
    apdex_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="apdexIds")
    application_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="applicationIds")
    business_perspective_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="businessPerspectiveIds")
    infra_dfq_filter: Optional[ScopeBinding] = Field(alias="infraDfqFilter")
    kubernetes_cluster_uuids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="kubernetesClusterUUIDs")
    kubernetes_namespace_uids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="kubernetesNamespaceUIDs")
    mobile_app_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="mobileAppIds")
    permissions: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)]
    ...
    slo_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="sloIds")
    synthetic_credential_keys: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="syntheticCredentialKeys")
    synthetic_test_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="syntheticTestIds")
    website_ids: Annotated[List[Optional[ScopeBinding]], Field(min_length=0, max_length=1024)] = Field(alias="websiteIds")
    __properties: ClassVar[List[str]] = ["actionFilter", "apdexIds", "applicationIds", "businessPerspectiveIds", "infraDfqFilter", "kubernetesClusterUUIDs", "kubernetesNamespaceUIDs", "mobileAppIds", "permissions", "restrictedApplicationFilter", "sloIds", "syntheticCredentialKeys", "syntheticTestIds", "websiteIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in apdex_ids (list)
        _items = []
        if self.apdex_ids:
            for _item_apdex_ids in self.apdex_ids:
                if _item_apdex_ids:
                    _items.append(_item_apdex_ids.to_dict())
            _dict['apdexIds'] = _items
        ...
        # set to None if action_filter (nullable) is None
        # and model_fields_set contains the field
        if self.action_filter is None and "action_filter" in self.model_fields_set:
            _dict['actionFilter'] = None

        # set to None if infra_dfq_filter (nullable) is None
        # and model_fields_set contains the field
        if self.infra_dfq_filter is None and "infra_dfq_filter" in self.model_fields_set:
            _dict['infraDfqFilter'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apdexIds": [ScopeBinding.from_dict(_item) for _item in obj["apdexIds"]] if obj.get("apdexIds") is not None else None,
