...
class BidirectionalSlackAppIntegration(AbstractIntegration):
    """
    ...
    emoji_rendering: Optional[StrictBool] = Field(default=None, alias="emojiRendering")
    ...
    __properties: ClassVar[List[str]] = ["id", "kind", "name", "timezone", "appId", "channelId", "channelName", "emojiRendering", "status", "teamId", "teamName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emojiRendering": obj.get("emojiRendering"),
