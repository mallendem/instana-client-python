...
class WebpageScriptConfiguration(SyntheticTypeConfiguration):
    ...
    script: Annotated[str, Field(min_length=0, strict=True, max_length=1048576)]
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticType", "timeout", "browser", "fileName", "recordVideo", "script"]
