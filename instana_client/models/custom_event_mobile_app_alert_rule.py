...
class CustomEventMobileAppAlertRule(MobileAppAlertRule):
    """
    CustomEventMobileAppAlertRule
    """ # noqa: E501
    custom_event_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="customEventName")
    metric_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(alias="metricName")
    __properties: ClassVar[List[str]] = ["aggregation", "alertType", "metricName", "customEventName"]
