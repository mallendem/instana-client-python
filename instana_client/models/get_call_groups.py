...
class GetCallGroups(BaseModel):
    ...
    tag_filters: Optional[Annotated[List[DeprecatedTagFilter], Field(min_length=0, max_length=10)]] = Field(default=None, alias="tagFilters")
