...
class Tag(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name of the tag. Eg: `call.name`")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if id_tag (nullable) is None
        # and model_fields_set contains the field
        if self.id_tag is None and "id_tag" in self.model_fields_set:
            _dict['idTag'] = None
