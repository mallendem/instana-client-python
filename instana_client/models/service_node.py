...
class ServiceNode(BaseModel):
    ...
    service_id: Annotated[str, Field(min_length=0, strict=True, max_length=64)] = Field(alias="serviceId")
    __properties: ClassVar[List[str]] = ["endpoints", "inclusive", "serviceId"]
