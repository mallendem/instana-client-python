...
class MetricInstance(BaseModel):
    ...
    metric_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="metricId")
    plugin_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="pluginId")
    __properties: ClassVar[List[str]] = ["custom", "description", "formatter", "label", "metricId", "pluginId"]
