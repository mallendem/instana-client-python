...
class EntityMetricScope(BaseModel):
    """
    EntityMetricScope
    """ # noqa: E501
    tag_filter_expression: Optional[TagFilterExpressionElement] = Field(default=None, alias="tagFilterExpression")
    type: StrictStr = Field(description="Type of the Entity Metric. Eg. For Mobile App SLO it would be any of the supported beaconTypes")
