...
class ApiTeamScope(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessPermissions", "actionFilter", "apdexIds", "applications", "businessPerspectives", "infraDfqFilter", "kubernetesClusters", "kubernetesNamespaces", "logFilter", "loggingPerspectives", "mobileApps", "restrictedApplicationFilter", "sloIds", "syntheticCredentials", "syntheticTests", "tagIds", "websites"]
