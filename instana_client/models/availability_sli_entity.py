...
class AvailabilitySliEntity(SliEntity):
    ...
    boundary_scope: Optional[StrictStr] = Field(description="Defines the boundary of calls to be monitored, specifying whether to track all calls or only inbound calls", alias="boundaryScope")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bad_event_filter_expression (nullable) is None
        # and model_fields_set contains the field
        if self.bad_event_filter_expression is None and "bad_event_filter_expression" in self.model_fields_set:
            _dict['badEventFilterExpression'] = None

        # set to None if bad_event_filters (nullable) is None
        # and model_fields_set contains the field
        if self.bad_event_filters is None and "bad_event_filters" in self.model_fields_set:
            _dict['badEventFilters'] = None

        # set to None if boundary_scope (nullable) is None
        # and model_fields_set contains the field
        if self.boundary_scope is None and "boundary_scope" in self.model_fields_set:
            _dict['boundaryScope'] = None
        ...
        # set to None if good_event_filter_expression (nullable) is None
        # and model_fields_set contains the field
        if self.good_event_filter_expression is None and "good_event_filter_expression" in self.model_fields_set:
            _dict['goodEventFilterExpression'] = None

        # set to None if good_event_filters (nullable) is None
        # and model_fields_set contains the field
        if self.good_event_filters is None and "good_event_filters" in self.model_fields_set:
            _dict['goodEventFilters'] = None
