...
class SpanExcerpt(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The technical type of the span. For example, `node.http.client` or `jdbc`.")
    ...
    sampling_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The probability at which this span was sampled by the tracer. Only present if the span was subjected to sampling.", alias="samplingRate")
    ...
    __properties: ClassVar[List[str]] = ["data", "databaseIntegrations", "duration", "errorCount", "foreignParentId", "id", "kind", "name", "parentId", "samplingRate", "stackTrace", "start"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if foreign_parent_id (nullable) is None
        # and model_fields_set contains the field
        if self.foreign_parent_id is None and "foreign_parent_id" in self.model_fields_set:
            _dict['foreignParentId'] = None
