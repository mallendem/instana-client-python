...
class GetAvailableMetricsQuery(BaseModel):
    ...
    """ # noqa: E501
    query: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=200)]] = Field(default=None, description="Search term used to filter results using fields such as label, description, tag name or keywords")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Entity type. Identifier for the monitored technology.")
    __properties: ClassVar[List[str]] = ["query", "tagFilterExpression", "timeFrame", "type"]
