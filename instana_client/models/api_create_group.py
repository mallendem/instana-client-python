...
class ApiCreateGroup(BaseModel):
    """
    ApiCreateGroup
    """ # noqa: E501
    ...
    permission_set: ApiPermissionSet = Field(alias="permissionSet")
    __properties: ClassVar[List[str]] = ["description", "members", "name", "permissionSet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "members": [ApiMember.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "name": obj.get("name"),
            "permissionSet": ApiPermissionSet.from_dict(obj["permissionSet"]) if obj.get("permissionSet") is not None else None
        })
        return _obj
