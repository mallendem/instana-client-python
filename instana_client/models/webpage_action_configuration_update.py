...
class WebpageActionConfigurationUpdate(SyntheticTypeConfigurationUpdate):
    """
    ...
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticTest", "syntheticType", "timeout", "browser", "recordVideo", "url"]
