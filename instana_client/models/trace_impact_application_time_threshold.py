...
class TraceImpactApplicationTimeThreshold(ApplicationTimeThreshold):
    """
    TraceImpactApplicationTimeThreshold
    """ # noqa: E501
    requests: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["timeWindow", "type", "requests"]
