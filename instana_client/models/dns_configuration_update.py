...
class DNSConfigurationUpdate(SyntheticTypeConfigurationUpdate):
    """
    DNSConfigurationUpdate
    """ # noqa: E501
    accept_cname: Optional[StrictBool] = Field(default=None, alias="acceptCNAME")
    lookup: Optional[StrictStr] = None
    ...
    target_values: Optional[SyntheticResourceUpdateListDNSFilterTargetValueListDNSFilterTargetValue] = Field(default=None, alias="targetValues")
    transport: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticTest", "syntheticType", "timeout", "acceptCNAME", "lookup", "lookupServerName", "port", "queryTime", "queryType", "recursiveLookups", "server", "serverRetries", "targetValues", "transport"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of target_values
        if self.target_values:
            _dict['targetValues'] = self.target_values.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetValues": SyntheticResourceUpdateListDNSFilterTargetValueListDNSFilterTargetValue.from_dict(obj["targetValues"]) if obj.get("targetValues") is not None else None,
