...
class HttpScriptConfiguration(SyntheticTypeConfiguration):
    """
    ...
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticType", "timeout", "fileName", "github", "script", "scriptType", "scripts"]
