...
class ServiceMapConnection(BaseModel):
    ...
    var_from: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The service that initiates a request to another service. It contains a unique service id. Eg: `24558242fdeb52571cfb9fa42f1b334aa65d7e61`. ", alias="from")
    ...
    to: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The service that receives the request sent by the source service. It contains a unique service id. Eg: `3feb3dcd206c166ef2b41c707e0cd38d7cd325aa`. ")
