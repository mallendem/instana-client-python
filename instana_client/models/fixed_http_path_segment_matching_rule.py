...
class FixedHttpPathSegmentMatchingRule(HttpPathSegmentMatchingRule):
    """
    FixedHttpPathSegmentMatchingRule
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Given `/api/{version}/users` URI, `FIXED` names are `api` and `users` in order. ")
