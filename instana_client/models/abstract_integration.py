...
class AbstractIntegration(BaseModel):
    ...
    AbstractIntegration
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique ID of the returned Alert Channel")
    ...
    timezone: Optional[StrictStr] = Field(default=None, description="The timezone to be used for DateTime")
    __properties: ClassVar[List[str]] = ["id", "kind", "name", "timezone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[BidirectionalMsTeamsAppIntegration, BidirectionalSlackAppIntegration, EmailIntegration, GoogleChatIntegration, NS1Integration, Office365Integration, OpsgenieIntegration, PagerdutyIntegration, PrometheusWebhookIntegration, SalesforceIntegration, ServiceNowEnhancedIntegration, ServiceNowIntegration, SlackIntegration, SplunkIntegration, VictorOpsIntegration, WatsonAIOpsWebhookIntegration, WebexTeamsWebhookIntegration, WebhookIntegration, ZChatOpsIntegration]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BidirectionalMsTeamsAppIntegration, BidirectionalSlackAppIntegration, EmailIntegration, GoogleChatIntegration, NS1Integration, Office365Integration, OpsgenieIntegration, PagerdutyIntegration, PrometheusWebhookIntegration, SalesforceIntegration, ServiceNowEnhancedIntegration, ServiceNowIntegration, SlackIntegration, SplunkIntegration, VictorOpsIntegration, WatsonAIOpsWebhookIntegration, WebexTeamsWebhookIntegration, WebhookIntegration, ZChatOpsIntegration]]:
        ...
        if object_type ==  'NS1Integration':
            return import_module("instana_client.models.ns1_integration").NS1Integration.from_dict(obj)
