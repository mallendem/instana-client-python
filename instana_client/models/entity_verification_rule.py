...
class EntityVerificationRule(AbstractRule):
    """
    ...
    __properties: ClassVar[List[str]] = ["ruleType", "severity", "matchingEntityLabel", "matchingEntityType", "matchingOperator", "offlineDuration"]

    @field_validator('matching_operator')
    def matching_operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['is', 'contains', 'startsWith', 'endsWith']):
            raise ValueError("must be one of enum values ('is', 'contains', 'startsWith', 'endsWith')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchingEntityLabel": obj.get("matchingEntityLabel"),
            "matchingEntityType": obj.get("matchingEntityType"),
            "matchingOperator": obj.get("matchingOperator"),
            "offlineDuration": obj.get("offlineDuration")
        })
        return _obj
