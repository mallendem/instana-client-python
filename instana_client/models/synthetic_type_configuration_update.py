...
class SyntheticTypeConfigurationUpdate(BaseModel):
    ...
    def synthetic_test_validate_enum(cls, value):
        ...
        if value not in set(['BrowserScript', 'DNS', 'HTTPAction', 'HTTPScript', 'ICMP', 'SSLCertificate', 'WebpageAction', 'WebpageScript', 'NotConfigured']):
            raise ValueError("must be one of enum values ('BrowserScript', 'DNS', 'HTTPAction', 'HTTPScript', 'ICMP', 'SSLCertificate', 'WebpageAction', 'WebpageScript', 'NotConfigured')")
        return value
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'BrowserScript': 'BrowserScriptConfigurationUpdate','DNS': 'DNSConfigurationUpdate','HTTPAction': 'HttpActionConfigurationUpdate','HTTPScript': 'HttpScriptConfigurationUpdate','ICMP': 'ICMPConfigurationUpdate','SSLCertificate': 'SSLCertificateConfigurationUpdate','WebpageAction': 'WebpageActionConfigurationUpdate','WebpageScript': 'WebpageScriptConfigurationUpdate'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[BrowserScriptConfigurationUpdate, DNSConfigurationUpdate, HttpActionConfigurationUpdate, HttpScriptConfigurationUpdate, ICMPConfigurationUpdate, SSLCertificateConfigurationUpdate, WebpageActionConfigurationUpdate, WebpageScriptConfigurationUpdate]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BrowserScriptConfigurationUpdate, DNSConfigurationUpdate, HttpActionConfigurationUpdate, HttpScriptConfigurationUpdate, ICMPConfigurationUpdate, SSLCertificateConfigurationUpdate, WebpageActionConfigurationUpdate, WebpageScriptConfigurationUpdate]]:
        ...
        if object_type ==  'ICMPConfigurationUpdate':
            return import_module("instana_client.models.icmp_configuration_update").ICMPConfigurationUpdate.from_dict(obj)
