...
class SLOConfigWithRBACTag(BaseModel):
    """
    ...
    target: Union[Annotated[float, Field(le=0.9999, strict=True, gt=0)], Annotated[int, Field(le=0, strict=True, gt=0)]] = Field(description="Service Levels Objective Configuration Target")
    time_window: TimeWindow = Field(alias="timeWindow")
    __properties: ClassVar[List[str]] = ["createdDate", "entity", "id", "indicator", "lastUpdated", "name", "rbacTags", "tags", "target", "timeWindow"]
