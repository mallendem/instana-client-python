...
class TraceActivityTreeNodeDetails(BaseModel):
    ...
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The call ID. A unique identifier for an individual call. For example: `1bcad5c82338deaf`.")
    ...
    __properties: ClassVar[List[str]] = ["batchSelfTime", "batchSize", "destination", "duration", "errorCount", "id", "isSynthetic", "label", "logs", "minSelfTime", "networkTime", "rawSpanLoadError", "samplingFactor", "source", "spans", "start", "synthetic"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.spans:
            ...
            _dict['spans'] = _items
        # set to None if batch_self_time (nullable) is None
        # and model_fields_set contains the field
        if self.batch_self_time is None and "batch_self_time" in self.model_fields_set:
            _dict['batchSelfTime'] = None
        ...
        # set to None if min_self_time (nullable) is None
        # and model_fields_set contains the field
        if self.min_self_time is None and "min_self_time" in self.model_fields_set:
            _dict['minSelfTime'] = None

        # set to None if network_time (nullable) is None
        # and model_fields_set contains the field
        if self.network_time is None and "network_time" in self.model_fields_set:
            _dict['networkTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "samplingFactor": obj.get("samplingFactor"),
