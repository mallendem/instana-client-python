...
class Addition(ArithmeticOperation):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "left": ArithmeticOperand.from_dict(obj["left"]) if obj.get("left") is not None else None,
            "operator": obj.get("operator"),
            "right": ArithmeticOperand.from_dict(obj["right"]) if obj.get("right") is not None else None
        })
        return _obj
