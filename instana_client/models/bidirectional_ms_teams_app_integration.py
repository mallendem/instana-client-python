...
class BidirectionalMsTeamsAppIntegration(AbstractIntegration):
    ...
    """ # noqa: E501
    api_token_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="apiTokenId")
    channel_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="channelId")
    channel_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="channelName")
    instana_url: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="instanaUrl")
    ...
    __properties: ClassVar[List[str]] = ["id", "kind", "name", "timezone", "apiTokenId", "channelId", "channelName", "instanaUrl", "serviceUrl", "teamId", "teamName", "tenantId", "tenantName"]
