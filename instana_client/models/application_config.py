...
class ApplicationConfig(BaseModel):
    ...
    business_criticality: Optional[StrictStr] = Field(description="Business criticality level of the application", alias="businessCriticality")
    ...
    __properties: ClassVar[List[str]] = ["accessRules", "boundaryScope", "businessCriticality", "createdAt", "createdBy", "id", "label", "matchSpecification", "modifiedAt", "modifiedBy", "scope", "tagFilterExpression"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.business_criticality is None and "business_criticality" in self.model_fields_set:
            _dict['businessCriticality'] = None
