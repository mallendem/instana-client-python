...
class Endpoint(BaseModel):
    ...
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique ID of the Endpoint. Eg: `NCRq5oYnan5x-PkdTPQwLLUdu5M`.")
    is_synthetic: Optional[StrictBool] = Field(default=None, alias="isSynthetic")
    label: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the Endpoint. Eg: `GET /api/fetch`.")
    service_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The serviceId this endpoint belongs to.", alias="serviceId")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['UNDEFINED', 'RPC', 'EVENT', 'GRAPHQL', 'BATCH', 'SHELL', 'HTTP', 'SDK', 'OPENTELEMETRY', 'INTERNAL', 'RPG', 'DATABASE', 'MESSAGING', 'PAGE', 'PAGE_RESOURCE']):
            raise ValueError("must be one of enum values ('UNDEFINED', 'RPC', 'EVENT', 'GRAPHQL', 'BATCH', 'SHELL', 'HTTP', 'SDK', 'OPENTELEMETRY', 'INTERNAL', 'RPG', 'DATABASE', 'MESSAGING', 'PAGE', 'PAGE_RESOURCE')")
        return value
