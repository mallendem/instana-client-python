...
class SyntheticTypeConfiguration(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'BrowserScript': 'BrowserScriptConfiguration','DNS': 'DNSConfiguration','HTTPAction': 'HttpActionConfiguration','HTTPScript': 'HttpScriptConfiguration','ICMP': 'ICMPConfiguration','NotConfigured': 'EmptyConfiguration','SSLCertificate': 'SSLCertificateConfiguration','WebpageAction': 'WebpageActionConfiguration','WebpageScript': 'WebpageScriptConfiguration'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[BrowserScriptConfiguration, DNSConfiguration, HttpActionConfiguration, HttpScriptConfiguration, ICMPConfiguration, EmptyConfiguration, SSLCertificateConfiguration, WebpageActionConfiguration, WebpageScriptConfiguration]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BrowserScriptConfiguration, DNSConfiguration, HttpActionConfiguration, HttpScriptConfiguration, ICMPConfiguration, EmptyConfiguration, SSLCertificateConfiguration, WebpageActionConfiguration, WebpageScriptConfiguration]]:
        ...
        if object_type ==  'ICMPConfiguration':
            return import_module("instana_client.models.icmp_configuration").ICMPConfiguration.from_dict(obj)
