...
class SoftwareVersion(BaseModel):
    ...
    plugin: Annotated[str, Field(min_length=1, strict=True)]
    software_type: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="softwareType")
    used_by: List[SoftwareUser] = Field(alias="usedBy")
    vendor: Annotated[str, Field(min_length=1, strict=True)]
