...
class BrowserScriptConfiguration(SyntheticTypeConfiguration):
    """
    BrowserScriptConfiguration
    """ # noqa: E501
    browser: Optional[StrictStr] = None
    file_name: Optional[StrictStr] = Field(default=None, alias="fileName")
    github: Optional[GitHubConfiguration] = None
    record_video: Optional[StrictBool] = Field(default=None, alias="recordVideo")
    script: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1048576)]] = None
    script_type: Optional[StrictStr] = Field(default=None, alias="scriptType")
    scripts: Optional[MultipleScriptsConfiguration] = None
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticType", "timeout", "browser", "fileName", "github", "recordVideo", "script", "scriptType", "scripts"]
    ...
    def browser_validate_enum(cls, value):
        ...
        if value not in set(['chrome', 'firefox']):
            raise ValueError("must be one of enum values ('chrome', 'firefox')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "github": GitHubConfiguration.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "recordVideo": obj.get("recordVideo"),
