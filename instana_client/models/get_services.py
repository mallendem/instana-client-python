...
class GetServices(BaseModel):
    ...
    technologies: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=20)]] = Field(default=None, description="A list of technologies to be used for filtering data. For example, technologies could include AWS ECS, Cassandra, DB2, JVM, Kafka, etc. A full list of available technologies can be found in X.")
