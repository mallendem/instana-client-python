...
class ActionInstance(BaseModel):
    ...
    action_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Action identifier of the action to run.", alias="actionId")
    ...
    client_id: Optional[StrictStr] = Field(default=None, description="Client ID (tenant key) where the action instance is stored.", alias="clientId")
    ...
    originator_client_id: Optional[StrictStr] = Field(default=None, description="Client ID (tenant key) where the action/policy was executed from.", alias="originatorClientId")
    ...
    __properties: ClassVar[List[str]] = ["actionDescription", "actionId", "actionInstanceId", "actionName", "actionSnapshot", "actorId", "actorName", "actorType", "clientId", "createdDate", "endDate", "errorMessage", "eventEntityType", "eventId", "eventSpecificationId", "externalSourceType", "hostSnapshotId", "inputParameters", "metadata", "originatorClientId", "output", "policyId", "problemText", "returnCode", "startDate", "status", "targetSnapshotId", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "originatorClientId": obj.get("originatorClientId"),
