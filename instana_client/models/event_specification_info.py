...
class EventSpecificationInfo(BaseModel):
    """
    ...
    invalid: Optional[StrictBool] = None
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["description", "enabled", "entityType", "id", "invalid", "migrated", "name", "severity", "triggering", "type"]
