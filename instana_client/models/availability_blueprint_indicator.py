...
class AvailabilityBlueprintIndicator(ServiceLevelIndicator):
    """
    ...
    __properties: ClassVar[List[str]] = ["aggregation", "blueprint", "operator", "serviceLevelsMeasurement", "threshold", "type", "metric"]
