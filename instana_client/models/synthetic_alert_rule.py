...
class SyntheticAlertRule(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'failure': 'FailureSyntheticAlertRule'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[FailureSyntheticAlertRule]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[FailureSyntheticAlertRule]]:
        """Create an instance of SyntheticAlertRule from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'FailureSyntheticAlertRule':
            return import_module("instana_client.models.failure_synthetic_alert_rule").FailureSyntheticAlertRule.from_dict(obj)

        raise ValueError("SyntheticAlertRule failed to lookup discriminator value from " +
