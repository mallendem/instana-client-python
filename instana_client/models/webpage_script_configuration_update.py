...
class WebpageScriptConfigurationUpdate(SyntheticTypeConfigurationUpdate):
    """
    ...
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticTest", "syntheticType", "timeout", "browser", "fileName", "recordVideo", "script"]
