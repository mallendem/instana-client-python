...
class EventFilteringConfiguration(BaseModel):
    ...
    """ # noqa: E501
    application_alert_config_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)]] = Field(default=None, alias="applicationAlertConfigIds")
    ...
    rule_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)]] = Field(default=None, alias="ruleIds")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if application_alert_config_ids (nullable) is None
        # and model_fields_set contains the field
        if self.application_alert_config_ids is None and "application_alert_config_ids" in self.model_fields_set:
            _dict['applicationAlertConfigIds'] = None
