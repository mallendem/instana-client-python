...
class CustomEventSpecification(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["actions", "description", "enabled", "entityType", "expirationTime", "name", "query", "ruleLogicalOperator", "rules", "transientEventAlertMuted", "transientEventEnabled", "transientEventThreshold", "triggering"]
