...
class MobileAppAlertConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "completeTagFilterExpression", "customPayloadFields", "description", "enabled", "gracePeriod", "granularity", "id", "mobileAppId", "name", "rule", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold", "triggering"]
