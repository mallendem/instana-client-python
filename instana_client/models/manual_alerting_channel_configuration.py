...
class ManualAlertingChannelConfiguration(BaseModel):
    """
    ...
    event_id: Annotated[str, Field(min_length=0, strict=True, max_length=256)] = Field(description="Id of the event to be notified about.", alias="eventId")
    __properties: ClassVar[List[str]] = ["customPayloadFields", "eventId"]
