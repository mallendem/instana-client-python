...
class GetInfrastructureQuery(BaseModel):
    """
    GetInfrastructureQuery
    """ # noqa: E501
    metrics: Optional[Annotated[List[SimpleMetricConfiguration], Field(min_length=0, max_length=10)]] = None
    missing_placeholder: Optional[StrictStr] = Field(default=None, alias="missingPlaceholder")
    ...
    tags: Optional[Annotated[List[StrictStr], Field(min_length=0, max_length=5)]] = None
    time_frame: TimeFrame = Field(alias="timeFrame")
    type: Optional[StrictStr] = Field(default=None, description="Type of entities")
    __properties: ClassVar[List[str]] = ["metrics", "missingPlaceholder", "order", "pagination", "tagFilterExpression", "tags", "timeFrame", "type"]
