...
class SyntheticMetricTagGroup(BaseModel):
    ...
    include_others: Optional[StrictBool] = Field(default=None, alias="includeOthers")
    max_results: Optional[Annotated[int, Field(le=50, strict=True, ge=1)]] = Field(default=None, alias="maxResults")
    __properties: ClassVar[List[str]] = ["direction", "groupbyTag", "groupbyTagEntity", "groupbyTagSecondLevelKey", "includeOthers", "maxResults"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if groupby_tag_second_level_key (nullable) is None
        # and model_fields_set contains the field
        if self.groupby_tag_second_level_key is None and "groupby_tag_second_level_key" in self.model_fields_set:
            _dict['groupbyTagSecondLevelKey'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeOthers": obj.get("includeOthers"),
