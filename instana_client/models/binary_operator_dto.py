...
class BinaryOperatorDTO(MatchExpressionDTO):
    """
    BinaryOperatorDTO
    """ # noqa: E501
    conjunction: StrictStr
    left: MatchExpressionDTO
    right: MatchExpressionDTO
    __properties: ClassVar[List[str]] = ["type", "conjunction", "left", "right"]

    @field_validator('conjunction')
    def conjunction_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "conjunction": obj.get("conjunction"),
            "left": MatchExpressionDTO.from_dict(obj["left"]) if obj.get("left") is not None else None,
            "right": MatchExpressionDTO.from_dict(obj["right"]) if obj.get("right") is not None else None
        })
        return _obj
