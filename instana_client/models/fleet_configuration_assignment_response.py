...
class FleetConfigurationAssignmentResponse(BaseModel):
    """
    FleetConfigurationAssignmentResponse
    """ # noqa: E501
    assignment_id: Annotated[str, Field(min_length=1, strict=True)]
    message: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["assignment_id", "message"]
