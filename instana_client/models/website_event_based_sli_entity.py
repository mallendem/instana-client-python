...
class WebsiteEventBasedSliEntity(SliEntity):
    ...
    """ # noqa: E501
    bad_event_filter_expression: Optional[TagFilterExpressionElement] = Field(alias="badEventFilterExpression")
    beacon_type: StrictStr = Field(description="Enum value to specify the type of beacons to be monitored", alias="beaconType")
    good_event_filter_expression: Optional[TagFilterExpressionElement] = Field(alias="goodEventFilterExpression")
