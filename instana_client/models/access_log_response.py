...
class AccessLogResponse(BaseModel):
    ...
    AccessLogResponse
    """ # noqa: E501
    entries: Optional[List[AccessLogEntry]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["entries", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [AccessLogEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "total": obj.get("total")
        })
        return _obj
