...
class CorrectionConfiguration(BaseModel):
    ...
    slo_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)]] = Field(default=None, description="This is the list of SLO configurations related to this Correction Window.", alias="sloIds")
