...
class ApplicationEventResult(EventResult):
    """
    ApplicationEventResult
    """ # noqa: E501
    application_id: Optional[StrictStr] = Field(default=None, description="ID of the application.", alias="applicationId")
    __properties: ClassVar[List[str]] = ["aggregated", "detail", "end", "entityLabel", "entityName", "entityType", "eventId", "eventSpecificationId", "fixSuggestion", "metadata", "metrics", "probableCause", "problem", "recentEvents", "severity", "shortCode", "snapshotId", "start", "state", "triggeringEventId", "type", "applicationId"]
