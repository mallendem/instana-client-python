...
class WebpageActionConfiguration(SyntheticTypeConfiguration):
    """
    ...
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticType", "timeout", "browser", "recordVideo", "url"]
