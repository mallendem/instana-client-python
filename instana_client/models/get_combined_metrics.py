...
class GetCombinedMetrics(BaseModel):
    ...
    GetCombinedMetrics
    """ # noqa: E501
    metrics: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=1, max_length=5)] = Field(description="Id of the exact metric you want to retrieve, eg. \"cpu.user\", \"clientrequests.read.mean\"")
