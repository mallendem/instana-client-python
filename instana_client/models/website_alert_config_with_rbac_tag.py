...
class WebsiteAlertConfigWithRBACTag(BaseModel):
    ...
    rbac_tags: Optional[List[ApiTag]] = Field(default=None, description="RBAC tags associated with the website", alias="rbacTags")
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "created", "customPayloadFields", "description", "enabled", "gracePeriod", "granularity", "id", "initialCreated", "name", "rbacTags", "readOnly", "rule", "rules", "severity", "tagFilterExpression", "tagFilters", "threshold", "timeThreshold", "triggering", "websiteId"]
