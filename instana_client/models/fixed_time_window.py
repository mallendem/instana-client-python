...
class FixedTimeWindow(TimeWindow):
    ...
    FixedTimeWindow
    """ # noqa: E501
    start_timestamp: datetime = Field(description="The timestamp at which the fixed time window of the SLO starts", alias="startTimestamp")
    __properties: ClassVar[List[str]] = ["duration", "durationUnit", "timezone", "type", "startTimestamp"]
