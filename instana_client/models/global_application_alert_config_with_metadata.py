...
class GlobalApplicationAlertConfigWithMetadata(BaseModel):
    ...
    application_ids: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, description="IDs of the applications that this Smart Alert is applied to.", alias="applicationIds")
