...
class CallRelation(BaseModel):
    ...
    """ # noqa: E501
    endpoint: Optional[EndpointSimple] = None
    ...
    __properties: ClassVar[List[str]] = ["endpoint", "service", "technologies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoint": EndpointSimple.from_dict(obj["endpoint"]) if obj.get("endpoint") is not None else None,
            "service": ServiceSimple.from_dict(obj["service"]) if obj.get("service") is not None else None,
