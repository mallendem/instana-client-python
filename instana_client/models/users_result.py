...
class UsersResult(BaseModel):
    ...
    UsersResult
    """ # noqa: E501
    invitations: Optional[List[InvitationResult]] = None
    users: Optional[List[UserResult]] = None
    __properties: ClassVar[List[str]] = ["invitations", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invitations": [InvitationResult.from_dict(_item) for _item in obj["invitations"]] if obj.get("invitations") is not None else None,
            "users": [UserResult.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
