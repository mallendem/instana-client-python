...
class WebsiteEventResult(EventResult):
    """
    WebsiteEventResult
    """ # noqa: E501
    website_id: Optional[StrictStr] = Field(default=None, description="ID of the website.", alias="websiteId")
    __properties: ClassVar[List[str]] = ["aggregated", "detail", "end", "entityLabel", "entityName", "entityType", "eventId", "eventSpecificationId", "fixSuggestion", "metadata", "metrics", "probableCause", "problem", "recentEvents", "severity", "shortCode", "snapshotId", "start", "state", "triggeringEventId", "type", "websiteId"]
