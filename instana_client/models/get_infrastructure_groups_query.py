...
class GetInfrastructureGroupsQuery(BaseModel):
    """
    GetInfrastructureGroupsQuery
    """ # noqa: E501
    group_by: Annotated[List[StrictStr], Field(min_length=0, max_length=5)] = Field(description="Entity grouping tag. Use the Instana Analyze Infrastructure dashboard to determine the entity grouping tag name.", alias="groupBy")
    metrics: Optional[Annotated[List[SimpleMetricConfiguration], Field(min_length=0, max_length=10)]] = None
    missing_placeholder: Optional[StrictStr] = Field(default=None, description="Placeholder value for missing tag values", alias="missingPlaceholder")
    order: Optional[Order] = None
    pagination: CursorPaginationWithUiCursorInfraExploreCursor
    tag_filter_expression: Optional[TagFilterExpressionElement] = Field(alias="tagFilterExpression")
    time_frame: TimeFrame = Field(alias="timeFrame")
    type: Optional[StrictStr] = Field(default=None, description="Type of entities")
    __properties: ClassVar[List[str]] = ["groupBy", "metrics", "missingPlaceholder", "order", "pagination", "tagFilterExpression", "timeFrame", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if missing_placeholder (nullable) is None
        # and model_fields_set contains the field
        if self.missing_placeholder is None and "missing_placeholder" in self.model_fields_set:
            _dict['missingPlaceholder'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": [SimpleMetricConfiguration.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "missingPlaceholder": obj.get("missingPlaceholder"),
            "order": Order.from_dict(obj["order"]) if obj.get("order") is not None else None,
            "pagination": CursorPaginationWithUiCursorInfraExploreCursor.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
