...
class GetInfrastructureGroupsQuery(BaseModel):
    ...
    metrics: Optional[Annotated[List[InfraMetricConfiguration], Field(min_length=0, max_length=10)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": [InfraMetricConfiguration.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
