...
class EntityMetric(BaseModel):
    ...
    EntityMetric
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Entity Metric")
    scope: Optional[EntityMetricScope] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "scope": EntityMetricScope.from_dict(obj["scope"]) if obj.get("scope") is not None else None
        })
        return _obj
