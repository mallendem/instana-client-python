...
class CustomEntityWithMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["created", "data", "id", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CustomEntityModel.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "id": obj.get("id"),
