...
class GetSnapshotsQuery(BaseModel):
    ...
    GetSnapshotsQuery
    """ # noqa: E501
    snapshot_ids: Annotated[List[StrictStr], Field(min_length=0, max_length=1000)] = Field(description="List of one or more snapshot ids.", alias="snapshotIds")
    time_frame: Optional[TimeFrame] = Field(default=None, alias="timeFrame")
    __properties: ClassVar[List[str]] = ["snapshotIds", "timeFrame"]
