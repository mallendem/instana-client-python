...
class CustomMetricApplicationAlertRule(ApplicationAlertRule):
    """
    CustomMetricApplicationAlertRule
    """ # noqa: E501
    metric_key: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="metricKey")
    __properties: ClassVar[List[str]] = ["aggregation", "alertType", "metricName", "metricKey"]
