...
class ApiToken(BaseModel):
    ...
    ApiToken
    """ # noqa: E501
    access_granting_token: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="accessGrantingToken")
    can_collect_net_trace_logs: Optional[StrictBool] = Field(default=None, alias="canCollectNetTraceLogs")
    ...
    can_configure_application_business_criticality: Optional[StrictBool] = Field(default=None, alias="canConfigureApplicationBusinessCriticality")
    ...
    can_configure_gen_ai_evaluations: Optional[StrictBool] = Field(default=None, alias="canConfigureGenAIEvaluations")
    can_configure_gen_ai_smart_alerts: Optional[StrictBool] = Field(default=None, alias="canConfigureGenAISmartAlerts")
    ...
    can_configure_ip_filtering: Optional[StrictBool] = Field(default=None, alias="canConfigureIPFiltering")
    ...
    can_configure_llm_model_price: Optional[StrictBool] = Field(default=None, alias="canConfigureLLMModelPrice")
    ...
    can_configure_logging_perspectives: Optional[StrictBool] = Field(default=None, alias="canConfigureLoggingPerspectives")
    can_configure_maintenance_windows: Optional[StrictBool] = Field(default=None, alias="canConfigureMaintenanceWindows")
    can_configure_mobile_app_business_criticality: Optional[StrictBool] = Field(default=None, alias="canConfigureMobileAppBusinessCriticality")
    ...
    can_configure_network_integrations: Optional[StrictBool] = Field(default=None, alias="canConfigureNetworkIntegrations")
    can_configure_personal_api_tokens: Optional[StrictBool] = Field(default=None, alias="canConfigurePersonalApiTokens")
    can_configure_personally_identifiable_information_masking: Optional[StrictBool] = Field(default=None, alias="canConfigurePersonallyIdentifiableInformationMasking")
    ...
    can_configure_website_business_criticality: Optional[StrictBool] = Field(default=None, alias="canConfigureWebsiteBusinessCriticality")
    ...
    can_download_agent_configuration: Optional[StrictBool] = Field(default=None, alias="canDownloadAgentConfiguration")
    ...
    internal_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="internalId")
    ...
    limited_gen_ai_capabilities_scope: Optional[StrictBool] = Field(default=None, alias="limitedGenAICapabilitiesScope")
    ...
    limited_logging_perspectives_scope: Optional[StrictBool] = Field(default=None, alias="limitedLoggingPerspectivesScope")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_used_on (nullable) is None
        # and model_fields_set contains the field
        if self.last_used_on is None and "last_used_on" in self.model_fields_set:
            _dict['lastUsedOn'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canCollectNetTraceLogs": obj.get("canCollectNetTraceLogs"),
            ...
            "canConfigureApplicationBusinessCriticality": obj.get("canConfigureApplicationBusinessCriticality"),
            ...
            "canConfigureGenAIEvaluations": obj.get("canConfigureGenAIEvaluations"),
            "canConfigureGenAISmartAlerts": obj.get("canConfigureGenAISmartAlerts"),
            ...
            "canConfigureIPFiltering": obj.get("canConfigureIPFiltering"),
            "canConfigureIntegrations": obj.get("canConfigureIntegrations"),
            "canConfigureLLM": obj.get("canConfigureLLM"),
            "canConfigureLLMModelPrice": obj.get("canConfigureLLMModelPrice"),
            ...
            "canConfigureLoggingPerspectives": obj.get("canConfigureLoggingPerspectives"),
            "canConfigureMaintenanceWindows": obj.get("canConfigureMaintenanceWindows"),
            "canConfigureMobileAppBusinessCriticality": obj.get("canConfigureMobileAppBusinessCriticality"),
            ...
            "canConfigureNetworkIntegrations": obj.get("canConfigureNetworkIntegrations"),
            "canConfigurePersonalApiTokens": obj.get("canConfigurePersonalApiTokens"),
            "canConfigurePersonallyIdentifiableInformationMasking": obj.get("canConfigurePersonallyIdentifiableInformationMasking"),
            ...
            "canConfigureWebsiteBusinessCriticality": obj.get("canConfigureWebsiteBusinessCriticality"),
            ...
            "canDownloadAgentConfiguration": obj.get("canDownloadAgentConfiguration"),
            ...
            "limitedGenAICapabilitiesScope": obj.get("limitedGenAICapabilitiesScope"),
            ...
            "limitedLoggingPerspectivesScope": obj.get("limitedLoggingPerspectivesScope"),
