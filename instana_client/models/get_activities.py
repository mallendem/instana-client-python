...
class GetActivities(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order", "pagination", "tagFilterExpression", "timeFrame", "timeframe"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of timeframe
        if self.timeframe:
            _dict['timeframe'] = self.timeframe.to_dict()
