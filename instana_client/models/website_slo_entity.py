...
class WebsiteSloEntity(SloEntity):
    """
    WebsiteSloEntity
    """ # noqa: E501
    beacon_type: StrictStr = Field(description="Type of Website Beacon to be considered for the SLO", alias="beaconType")
    website_id: StrictStr = Field(description="The ID of the Website", alias="websiteId")
    __properties: ClassVar[List[str]] = ["tagFilterExpression", "type", "beaconType", "websiteId"]
