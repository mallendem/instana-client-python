...
class ArithmeticOperation(BaseModel):
    ...
    def operator_validate_enum(cls, value):
        ...
        if value not in set(['ADDITION', 'SUBTRACTION', 'MULTIPLICATION', 'DIVISION', 'NOOP', 'UNRECOGNIZED']):
            raise ValueError("must be one of enum values ('ADDITION', 'SUBTRACTION', 'MULTIPLICATION', 'DIVISION', 'NOOP', 'UNRECOGNIZED')")
        return value
