...
class PathParameterHttpPathSegmentMatchingRule(HttpPathSegmentMatchingRule):
    """
    PathParameterHttpPathSegmentMatchingRule
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Given `/api/{version}/users` URI, `PARAMETER` name is `version`. ")
