...
class StaticStringField(CustomPayloadField):
    """
    StaticStringField
    """ # noqa: E501
    value: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Custom value for static type custom payload")
