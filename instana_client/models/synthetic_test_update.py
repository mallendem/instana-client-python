...
class SyntheticTestUpdate(BaseModel):
    ...
    rbac_tags: Optional[SyntheticResourceUpdateListStringListString] = Field(default=None, alias="rbacTags")
    ...
    __properties: ClassVar[List[str]] = ["active", "applications", "customProperties", "ids", "lastModifiedAt", "locations", "mobileApps", "modifiedBy", "rbacTags", "shallowUpdate", "syntheticUpdateType", "testFrequency", "websites"]
