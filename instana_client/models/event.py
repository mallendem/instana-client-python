...
class Event(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affectedEntities", "end", "endpointServiceId", "entityId", "entityType", "eventConfigurationType", "id", "longFormPluginId", "metadata", "metricAccessId", "plugin", "problem", "rbacTags", "rca", "shortCode", "start", "state", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if affected_entities (nullable) is None
        # and model_fields_set contains the field
        if self.affected_entities is None and "affected_entities" in self.model_fields_set:
            _dict['affectedEntities'] = None

        # set to None if metric_access_id (nullable) is None
        # and model_fields_set contains the field
        if self.metric_access_id is None and "metric_access_id" in self.model_fields_set:
            _dict['metricAccessId'] = None

        # set to None if rbac_tags (nullable) is None
        # and model_fields_set contains the field
        if self.rbac_tags is None and "rbac_tags" in self.model_fields_set:
            _dict['rbacTags'] = None
