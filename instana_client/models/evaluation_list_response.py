...
class EvaluationListResponse(BaseModel):
    ...
    """ # noqa: E501
    evaluations: Optional[List[EvaluationListItem]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["evaluations", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evaluations": [EvaluationListItem.from_dict(_item) for _item in obj["evaluations"]] if obj.get("evaluations") is not None else None,
            "total": obj.get("total")
        })
        return _obj
