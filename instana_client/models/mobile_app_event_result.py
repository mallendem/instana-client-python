...
class MobileAppEventResult(EventResult):
    """
    MobileAppEventResult
    """ # noqa: E501
    mobile_app_id: Optional[StrictStr] = Field(default=None, description="ID of the mobile app.", alias="mobileAppId")
    __properties: ClassVar[List[str]] = ["aggregated", "detail", "end", "entityLabel", "entityName", "entityType", "eventId", "eventSpecificationId", "fixSuggestion", "metadata", "metrics", "probableCause", "problem", "recentEvents", "severity", "shortCode", "snapshotId", "start", "state", "triggeringEventId", "type", "mobileAppId"]
