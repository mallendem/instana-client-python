...
class HttpActionConfiguration(SyntheticTypeConfiguration):
    ...
    expect_exists: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, alias="expectExists")
    ...
    expect_not_empty: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, alias="expectNotEmpty")
