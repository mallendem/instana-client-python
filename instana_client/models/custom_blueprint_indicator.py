...
class CustomBlueprintIndicator(ServiceLevelIndicator):
    ...
    good_events_filter: Optional[TagFilterExpressionElement] = Field(alias="goodEventsFilter")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bad_events_filter (nullable) is None
        # and model_fields_set contains the field
        if self.bad_events_filter is None and "bad_events_filter" in self.model_fields_set:
            _dict['badEventsFilter'] = None

        # set to None if good_events_filter (nullable) is None
        # and model_fields_set contains the field
        if self.good_events_filter is None and "good_events_filter" in self.model_fields_set:
            _dict['goodEventsFilter'] = None
