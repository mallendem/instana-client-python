...
class ApplicationNode(BaseModel):
    ...
    """ # noqa: E501
    application_id: Annotated[str, Field(min_length=0, strict=True, max_length=64)] = Field(alias="applicationId")
    inclusive: Optional[StrictBool] = None
    services: Dict[str, ServiceNode]
    __properties: ClassVar[List[str]] = ["applicationId", "inclusive", "services"]
