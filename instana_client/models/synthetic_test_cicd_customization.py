...
class SyntheticTestCICDCustomization(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["configuration", "customProperties", "locations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": SyntheticConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
