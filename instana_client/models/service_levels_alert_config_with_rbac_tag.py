...
class ServiceLevelsAlertConfigWithRBACTag(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "burnRateConfig", "burnRateTimeWindows", "created", "customPayloadFields", "description", "enabled", "id", "initialCreated", "name", "rbacTags", "readOnly", "rule", "severity", "sloIds", "threshold", "timeThreshold", "triggering"]
