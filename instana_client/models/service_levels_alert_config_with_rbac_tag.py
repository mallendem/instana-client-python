...
class ServiceLevelsAlertConfigWithRBACTag(BaseModel):
    """
    ServiceLevelsAlertConfigWithRBACTag
    """ # noqa: E501
    alert_channel_ids: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)] = Field(description="This is the list of channel IDs when alert triggered and sent to.", alias="alertChannelIds")
    apdex_ids: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)] = Field(description="This is the list of Apdex configurations related to this alert (mutually exclusive with sloIds).", alias="apdexIds")
    ...
    rbac_tags: Optional[List[ApiTag]] = Field(default=None, description="RBAC tags associated with the service levels", alias="rbacTags")
    ...
    slo_ids: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)] = Field(description="This is the list of SLO configurations related to this alert.", alias="sloIds")
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "apdexIds", "burnRateConfig", "burnRateTimeWindows", "created", "customPayloadFields", "description", "enabled", "id", "initialCreated", "name", "rbacTags", "readOnly", "rule", "severity", "sloIds", "threshold", "timeThreshold", "triggering"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if burn_rate_config (nullable) is None
        # and model_fields_set contains the field
        if self.burn_rate_config is None and "burn_rate_config" in self.model_fields_set:
            _dict['burnRateConfig'] = None

        # set to None if burn_rate_time_windows (nullable) is None
        # and model_fields_set contains the field
        if self.burn_rate_time_windows is None and "burn_rate_time_windows" in self.model_fields_set:
            _dict['burnRateTimeWindows'] = None
