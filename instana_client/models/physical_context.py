...
class PhysicalContext(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cloudfoundry (nullable) is None
        # and model_fields_set contains the field
        if self.cloudfoundry is None and "cloudfoundry" in self.model_fields_set:
            _dict['cloudfoundry'] = None
        ...
        # set to None if kubernetes (nullable) is None
        # and model_fields_set contains the field
        if self.kubernetes is None and "kubernetes" in self.model_fields_set:
            _dict['kubernetes'] = None
