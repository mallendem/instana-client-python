...
class LocationStatus(BaseModel):
    ...
    location_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="locationId")
    ...
    success_runs: Optional[StrictInt] = Field(default=None, alias="successRuns")
    total_test_runs: Optional[StrictInt] = Field(default=None, alias="totalTestRuns")
    __properties: ClassVar[List[str]] = ["locationDisplayLabel", "locationId", "locationType", "successRate", "successRuns", "totalTestRuns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "successRuns": obj.get("successRuns"),
            "totalTestRuns": obj.get("totalTestRuns")
        })
        return _obj
