...
class SpanRelation(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if physical_context (nullable) is None
        # and model_fields_set contains the field
        if self.physical_context is None and "physical_context" in self.model_fields_set:
            _dict['physicalContext'] = None
