...
class CustomEventSpecificationWithLastUpdated(BaseModel):
    ...
    infra_alert_config_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=64)]] = Field(default=None, alias="infraAlertConfigId")
    ...
    __properties: ClassVar[List[str]] = ["actions", "applicationAlertConfigId", "deleted", "description", "enabled", "entityType", "expirationTime", "id", "infraAlertConfigId", "lastUpdated", "migrated", "name", "query", "ruleLogicalOperator", "rules", "transientEventAlertMuted", "transientEventEnabled", "transientEventThreshold", "triggering"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.rules:
            ...
            _dict['rules'] = _items
        # set to None if application_alert_config_id (nullable) is None
        # and model_fields_set contains the field
        if self.application_alert_config_id is None and "application_alert_config_id" in self.model_fields_set:
            _dict['applicationAlertConfigId'] = None

        # set to None if infra_alert_config_id (nullable) is None
        # and model_fields_set contains the field
        if self.infra_alert_config_id is None and "infra_alert_config_id" in self.model_fields_set:
            _dict['infraAlertConfigId'] = None
        ...
        # set to None if transient_event_alert_muted (nullable) is None
        # and model_fields_set contains the field
        if self.transient_event_alert_muted is None and "transient_event_alert_muted" in self.model_fields_set:
            _dict['transientEventAlertMuted'] = None

        # set to None if transient_event_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.transient_event_enabled is None and "transient_event_enabled" in self.model_fields_set:
            _dict['transientEventEnabled'] = None

        # set to None if transient_event_threshold (nullable) is None
        # and model_fields_set contains the field
        if self.transient_event_threshold is None and "transient_event_threshold" in self.model_fields_set:
            _dict['transientEventThreshold'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "infraAlertConfigId": obj.get("infraAlertConfigId"),
