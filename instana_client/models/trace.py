...
class Trace(BaseModel):
    ...
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The trace ID. All spans of the same trace must have the same trace ID. For example, `e93282c0d5018320`.")
    label: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the trace.")
