...
class MobileAppAlertConfigWithRBACTag(BaseModel):
    """
    ...
    rbac_tags: Optional[List[ApiTag]] = Field(default=None, description="RBAC tags associated with the mobile app", alias="rbacTags")
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "completeTagFilterExpression", "created", "customPayloadFields", "description", "enabled", "gracePeriod", "granularity", "id", "initialCreated", "mobileAppId", "name", "rbacTags", "readOnly", "rule", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold", "triggering"]
