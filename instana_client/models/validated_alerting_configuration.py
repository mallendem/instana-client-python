...
class ValidatedAlertingConfiguration(BaseModel):
    """
    ValidatedAlertingConfiguration
    """ # noqa: E501
    alert_channel_names: Optional[List[StrictStr]] = Field(default=None, description="Set of Alert Channel names added in the Alert Configuration.", alias="alertChannelNames")
    ...
    application_names: Optional[List[StrictStr]] = Field(default=None, description="Set of Application Perspective names added in the Alert Configuration.", alias="applicationNames")
    custom_payload_fields: Annotated[List[CustomPayloadField], Field(min_length=0, max_length=20)] = Field(description="Custom payload fields to send additional information in the alert notifications. Supports both static and dynamic fields. Can be left empty.", alias="customPayloadFields")
    ...
    integration_ids: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=1024)] = Field(description="List of Alert Channel IDs added in this Alert Configuration.", alias="integrationIds")
    invalid: Optional[StrictBool] = Field(default=None, description="Flag to show whether the Alert Configuration is valid.")
    ...
    __properties: ClassVar[List[str]] = ["alertChannelNames", "alertName", "applicationNames", "customPayloadFields", "eventFilteringConfiguration", "id", "includeEntityNameInLegacyAlerts", "integrationIds", "invalid", "lastUpdated", "muteUntil"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alertChannelNames": obj.get("alertChannelNames"),
