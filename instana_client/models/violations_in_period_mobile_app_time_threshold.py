...
class ViolationsInPeriodMobileAppTimeThreshold(MobileAppTimeThreshold):
    """
    ViolationsInPeriodMobileAppTimeThreshold
    """ # noqa: E501
    violations: Optional[Annotated[int, Field(le=12, strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["timeWindow", "type", "violations"]
