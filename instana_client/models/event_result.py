...
class EventResult(BaseModel):
    ...
    EventResult
    """ # noqa: E501
    aggregated: Optional[StrictBool] = Field(default=None, description="Whether this event is aggregated across multiple entities.")
    ...
    metadata: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Additional event meta data.")
    ...
    triggering_event_id: Optional[StrictStr] = Field(default=None, description="The triggering event ID in case of an incident.", alias="triggeringEventId")
    type: Optional[StrictStr] = Field(default=None, description="The type of Event.")
    __properties: ClassVar[List[str]] = ["aggregated", "detail", "end", "entityLabel", "entityName", "entityType", "eventId", "eventSpecificationId", "fixSuggestion", "metadata", "metrics", "probableCause", "problem", "recentEvents", "severity", "shortCode", "snapshotId", "start", "state", "triggeringEventId", "type"]
