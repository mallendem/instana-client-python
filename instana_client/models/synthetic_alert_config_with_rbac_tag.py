...
class SyntheticAlertConfigWithRBACTag(BaseModel):
    """
    ...
    rbac_tags: Optional[List[ApiTag]] = Field(default=None, description="RBAC tags associated with the synthetic test", alias="rbacTags")
    ...
    __properties: ClassVar[List[str]] = ["affectedLocationsCount", "alertChannelIds", "created", "customPayloadFields", "description", "enabled", "evaluationType", "gracePeriod", "id", "includeOnDemand", "initialCreated", "name", "rbacTags", "readOnly", "rule", "severity", "syntheticTestIds", "tagFilterExpression", "timeThreshold"]
