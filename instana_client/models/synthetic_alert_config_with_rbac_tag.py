...
class SyntheticAlertConfigWithRBACTag(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "created", "customPayloadFields", "description", "enabled", "gracePeriod", "id", "initialCreated", "name", "rbacTags", "readOnly", "rule", "severity", "syntheticTestIds", "tagFilterExpression", "timeThreshold"]
