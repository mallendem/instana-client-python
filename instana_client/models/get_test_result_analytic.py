...
class GetTestResultAnalytic(BaseModel):
    """
    GetTestResultAnalytic
    """ # noqa: E501
    analytic_function: Optional[StrictStr] = Field(default=None, alias="analyticFunction")
    include_location_id_grouping: Optional[StrictBool] = Field(default=None, alias="includeLocationIdGrouping")
    ...
    __properties: ClassVar[List[str]] = ["analyticFunction", "includeLocationIdGrouping", "order", "pagination", "syntheticMetrics", "tagFilterExpression", "tagFilters", "timeFrame"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "analyticFunction": obj.get("analyticFunction"),
            "includeLocationIdGrouping": obj.get("includeLocationIdGrouping"),
