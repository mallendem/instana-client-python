...
class LogAlertRule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[LogCountAlertRule]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[LogCountAlertRule]]:
        """Create an instance of LogAlertRule from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'LogCountAlertRule':
            return import_module("instana_client.models.log_count_alert_rule").LogCountAlertRule.from_dict(obj)

        raise ValueError("LogAlertRule failed to lookup discriminator value from " +
