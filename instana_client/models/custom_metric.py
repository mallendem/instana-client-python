...
class CustomMetric(BaseModel):
    ...
    CustomMetric
    """ # noqa: E501
    aggregation: StrictStr = Field(description="Aggregation to apply on the metric for every member.")
    ...
    source: StrictStr = Field(description="Name of the source metric")
    ...
    def aggregation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['MEAN', 'SUM']):
            raise ValueError("must be one of enum values ('MEAN', 'SUM')")
        return value
