...
class ValidatedAlertingChannelInputInfo(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Alert', 'WebsiteSmartAlert', 'MobileSmartAlert', 'ApplicationSmartAlert', 'GlobalApplicationSmartAlert', 'SyntheticSmartAlert', 'InfraSmartAlert', 'ServiceLevelSmartAlert', 'ApdexSmartAlert', 'LogSmartAlert']):
            raise ValueError("must be one of enum values ('Alert', 'WebsiteSmartAlert', 'MobileSmartAlert', 'ApplicationSmartAlert', 'GlobalApplicationSmartAlert', 'SyntheticSmartAlert', 'InfraSmartAlert', 'ServiceLevelSmartAlert', 'ApdexSmartAlert', 'LogSmartAlert')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if selected_events (nullable) is None
        # and model_fields_set contains the field
        if self.selected_events is None and "selected_events" in self.model_fields_set:
            _dict['selectedEvents'] = None
