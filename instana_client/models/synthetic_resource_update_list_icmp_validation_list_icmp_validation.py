...
class SyntheticResourceUpdateListICMPValidationListICMPValidation(BaseModel):
    """
    SyntheticResourceUpdateListICMPValidationListICMPValidation
    """ # noqa: E501
    add: Optional[List[ICMPValidation]] = None
    remove: Optional[List[ICMPValidation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add": [ICMPValidation.from_dict(_item) for _item in obj["add"]] if obj.get("add") is not None else None,
            "remove": [ICMPValidation.from_dict(_item) for _item in obj["remove"]] if obj.get("remove") is not None else None
        })
        return _obj
