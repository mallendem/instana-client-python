...
class ApplicationAnalyzeApi:
    ...
    def get_call_details(
        self,
        trace_id: Annotated[str, Field(min_length=1, strict=True)],
        call_id: Annotated[str, Field(min_length=1, strict=True)],
    ...
    @validate_call
    def get_task_flows_by_root_id(
        self,
        root_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_task_flows_by_root_id_serialize(
            root_id=root_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_task_flows_by_root_id_with_http_info(
        self,
        root_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_task_flows_by_root_id_without_preload_content(
        self,
        root_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_task_flows_by_root_id_serialize(
        self,
        root_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/genai-monitoring/analyze/tasks/{rootId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
