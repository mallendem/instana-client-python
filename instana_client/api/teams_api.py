...
class TeamsApi:
    ...
    def get_team_role_mappings(
        ...
        _param = self._get_team_role_mappings_serialize(
            team_id=team_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_team_role_mappings_with_http_info(
        self,
        team_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RoleMappingOverview]]:
        """Get team role mappings
    ...
    @validate_call
    def get_team_role_mappings_without_preload_content(
        self,
        team_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_team_role_mappings_serialize(
        self,
        team_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/settings/rbac/teams/{teamId}/mappings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_team(
        ...
        api_team: Annotated[ApiTeam, Field(description="Team to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param api_team: Team to update (required)
        :type api_team: ApiTeam
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
