...
class UserApi:
    ...
    def get_user_mappings(
        ...
        _param = self._get_user_mappings_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_user_mappings_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Id of the user")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_user_mappings_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Id of the user")],
        _request_timeout: Union[
            None,
    ...
    def _get_user_mappings_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/settings/users/{userId}/mappings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def revoke_pending_invitation(
        self,
        email: Annotated[str, Field(min_length=1, strict=True, description="Email of the invite for removal")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
