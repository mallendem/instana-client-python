...
class ReleasesApi:
    ...
    def get_release(
        self,
        release_id: Annotated[StrictStr, Field(description="The unique release id which one wants to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param release_id: The unique release id which one wants to retrieve. (required)
        :type release_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
