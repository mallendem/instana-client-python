...
class ServiceLevelsAlertConfigurationApi:
    ...
    @validate_call
    def bulk_delete_service_levels_alert_configs(
        self,
        ...
        _param = self._bulk_delete_service_levels_alert_configs_serialize(
    ...
    @validate_call
    def bulk_delete_service_levels_alert_configs_with_http_info(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_delete_service_levels_alert_configs_without_preload_content(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    def _bulk_delete_service_levels_alert_configs_serialize(
        self,
        request_body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/events/settings/global-alert-configs/service-levels/bulk/delete',
    ...
    @validate_call
    def bulk_disable_service_levels_alert_configs(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
        ...
        _param = self._bulk_disable_service_levels_alert_configs_serialize(
            request_body=request_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bulk_disable_service_levels_alert_configs_with_http_info(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_disable_service_levels_alert_configs_without_preload_content(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    def _bulk_disable_service_levels_alert_configs_serialize(
        self,
        request_body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/events/settings/global-alert-configs/service-levels/bulk/disable',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def bulk_enable_service_levels_alert_configs(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
        ...
        _param = self._bulk_enable_service_levels_alert_configs_serialize(
            request_body=request_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bulk_enable_service_levels_alert_configs_with_http_info(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_enable_service_levels_alert_configs_without_preload_content(
        self,
        request_body: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    def _bulk_enable_service_levels_alert_configs_serialize(
        self,
        request_body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/events/settings/global-alert-configs/service-levels/bulk/enable',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_active_service_levels_alert_configs(
        self,
        slo_id: Annotated[Optional[StrictStr], Field(description="SLO Configuration ID")] = None,
        apdex_id: Annotated[Optional[StrictStr], Field(description="Apdex Configuration ID")] = None,
        alert_type: Annotated[Optional[StrictStr], Field(description="Alert Type filter - either 'SLO' or 'APDEX'")] = None,
        ...
        :param slo_id: SLO Configuration ID
        :type slo_id: str
        :param apdex_id: Apdex Configuration ID
        :type apdex_id: str
        :param alert_type: Alert Type filter - either 'SLO' or 'APDEX'
        :type alert_type: str
    ...
    def _find_active_service_levels_alert_configs_serialize(
        ...
        if apdex_id is not None:
            ...
            _query_params.append(('apdexId', apdex_id))
            
        if alert_type is not None:
            
            _query_params.append(('alertType', alert_type))
    ...
    def find_service_levels_alert_config(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ServiceLevelsAlertConfigWithRBACTag",
            '404': "str",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def find_service_levels_alert_config_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceLevelsAlertConfigWithRBACTag]:
        """Get Service levels Alert Config
