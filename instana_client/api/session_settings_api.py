...
class SessionSettingsApi:
    ...
    def delete_session_settings(
        ...
        _param = self._delete_session_settings_serialize(
    ...
    @validate_call
    def delete_session_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def delete_session_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _delete_session_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/settings/session',
    ...
    def get_session_settings(
        ...
        _param = self._get_session_settings_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_session_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_session_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_session_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def set_session_settings(
        ...
        _param = self._set_session_settings_serialize(
    ...
    @validate_call
    def set_session_settings_with_http_info(
        self,
        session_settings: Optional[SessionSettings] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def set_session_settings_without_preload_content(
        self,
        session_settings: Optional[SessionSettings] = None,
        _request_timeout: Union[
            None,
    ...
    def _set_session_settings_serialize(
        self,
        session_settings,
        _request_auth,
        _content_type,
