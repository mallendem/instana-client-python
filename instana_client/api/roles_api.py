...
class RolesApi:
    ...
    def get_role_mappings(
        ...
        _param = self._get_role_mappings_serialize(
            role_id=role_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_role_mappings_with_http_info(
        self,
        role_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_role_mappings_without_preload_content(
        self,
        role_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_role_mappings_serialize(
        self,
        role_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/settings/rbac/roles/{roleId}/mappings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
