...
class AIManagementApi:
    ...
    def _add_llm_egress_gateway_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/llm/gateways',
    ...
    def delete_llm_egress_gateway(
        self,
        id: Annotated[StrictStr, Field(description="AI connection ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: AI connection ID (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_llm_egress_gateway_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/llm/gateways/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def disable_llm_egress_gateway(
        self,
        id: Annotated[StrictStr, Field(description="AI connection ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._disable_llm_egress_gateway_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def disable_llm_egress_gateway_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="AI connection ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def disable_llm_egress_gateway_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="AI connection ID")],
        _request_timeout: Union[
            None,
    ...
    def _disable_llm_egress_gateway_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/llm/gateways/{id}/disable',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _enable_llm_egress_gateway_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/llm/gateways/{id}/enable',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def test_llm_gateway(
        self,
        llm_gateway_test_connection_request: LLMGatewayTestConnectionRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param llm_gateway_test_connection_request: (required)
        :type llm_gateway_test_connection_request: LLMGatewayTestConnectionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._test_llm_gateway_serialize(
            llm_gateway_test_connection_request=llm_gateway_test_connection_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def test_llm_gateway_with_http_info(
        self,
        llm_gateway_test_connection_request: LLMGatewayTestConnectionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def test_llm_gateway_without_preload_content(
        self,
        llm_gateway_test_connection_request: LLMGatewayTestConnectionRequest,
        _request_timeout: Union[
            None,
    ...
    def _test_llm_gateway_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if llm_gateway_test_connection_request is not None:
            _body_params = llm_gateway_test_connection_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/llm/gateways/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
