...
class HostAgentApi:
    ...
    @validate_call
    def get_agent_configuration_by_host(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_agent_configuration_by_host_serialize(
            host_id=host_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_agent_configuration_by_host_with_http_info(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_agent_configuration_by_host_without_preload_content(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_agent_configuration_by_host_serialize(
        self,
        host_id,
        _request_auth,
        _content_type,
    ...
    def get_agent_support_information(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        support_info_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def update_mode_by_host(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        agent_mode_update: Optional[AgentModeUpdate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param host_id: (required)
        :type host_id: str
        :param agent_mode_update:
        :type agent_mode_update: AgentModeUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_mode_by_host_serialize(
            host_id=host_id,
            agent_mode_update=agent_mode_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_mode_by_host_with_http_info(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        agent_mode_update: Optional[AgentModeUpdate] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_mode_by_host_without_preload_content(
        self,
        host_id: Annotated[str, Field(min_length=1, strict=True)],
        agent_mode_update: Optional[AgentModeUpdate] = None,
        _request_timeout: Union[
    ...
    def _update_mode_by_host_serialize(
        self,
        host_id,
        agent_mode_update,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if agent_mode_update is not None:
            _body_params = agent_mode_update
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/host-agent/{hostId}/mode',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_mode_by_query(
        ...
        _param = self._update_mode_by_query_serialize(
            query=query,
            size=size,
            agent_mode_update=agent_mode_update,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_mode_by_query_with_http_info(
        self,
        query: Annotated[str, Field(min_length=1, strict=True)],
        size: Optional[StrictInt] = None,
        agent_mode_update: Optional[AgentModeUpdate] = None,
    ...
    @validate_call
    def update_mode_by_query_without_preload_content(
        self,
        query: Annotated[str, Field(min_length=1, strict=True)],
        size: Optional[StrictInt] = None,
        agent_mode_update: Optional[AgentModeUpdate] = None,
    ...
    def _update_mode_by_query_serialize(
        self,
        query,
        size,
        agent_mode_update,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/host-agent/mode',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
