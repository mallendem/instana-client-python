...
class InfrastructureMetricsApi:
    ...
    def get_cassandra_metrics(
        ...
        :param get_combined_metrics: (required)
        :type get_combined_metrics: GetCombinedMetrics
        ...
        _param = self._get_cassandra_metrics_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InfrastructureMetricResult",
        }
    ...
    @validate_call
    def get_cassandra_metrics_with_http_info(
        self,
        get_combined_metrics: GetCombinedMetrics,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InfrastructureMetricResult]:
        """Cassandra metrics
    ...
    @validate_call
    def get_cassandra_metrics_without_preload_content(
        self,
        get_combined_metrics: GetCombinedMetrics,
        _request_timeout: Union[
            None,
    ...
    def _get_cassandra_metrics_serialize(
        self,
        ...
        if get_combined_metrics is not None:
            _body_params = get_combined_metrics
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/cassandra/metrics',
    ...
    def get_infrastructure_metrics(
        ...
        get_combined_metrics: Optional[GetCombinedMetrics] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_infrastructure_metrics_serialize(
            offline=offline,
            get_combined_metrics=get_combined_metrics,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_infrastructure_metrics_with_http_info(
        self,
        offline: Optional[StrictBool] = None,
        get_combined_metrics: Optional[GetCombinedMetrics] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_infrastructure_metrics_without_preload_content(
        self,
        offline: Optional[StrictBool] = None,
        get_combined_metrics: Optional[GetCombinedMetrics] = None,
        _request_timeout: Union[
    ...
    def _get_infrastructure_metrics_serialize(
        self,
        offline,
        get_combined_metrics,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/infrastructure-monitoring/metrics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
