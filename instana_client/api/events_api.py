...
class EventsApi:
    ...
    def get_event(
        ...
        include_metadata: Annotated[Optional[StrictBool], Field(description="Option to include event metadata")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type event_id: str
        :param include_metadata: Option to include event metadata
